   ...
   function urlapAzonosito(){
    if(document.getElementsByTagName('h1').length>0){
       ...
       break;
          ...
          case 'Törzslap ':
          if(document.querySelector('.modal-title').textContent==='Új ellátás hozzáadása' && (!document.getElementsByTagName('h3')[0])) /* az utóbbi 'h3' feltétel EDDA esetében lehetetlenné teszi a felismerést, nála ki kell venni*/
