...
function KiLocalStoragebol(){
   ...
   {[vezeteknev, utonev,vizsgDatum, diagnozis, osztalyfok, hanyadikVizsg,megfigyelesVoltE, gyogyPed,pszichologus,OA, KerelmezoFehId,beErkezett,mikorFigyelteMeg,fvTaneve] = JSON.parse(localStorage['vizsgaltGyerek'])}
...
function mentettBetolto(kivalasztottStorage){
   [vezeteknev, utonev,vizsgDatum, diagnozis, osztalyfok, hanyadikVizsg, gyogyPed,pszichologus,OA, KerelmezoFehId,beErkezett] = JSON.parse(localStorage['vizsgaltGyerek'])
